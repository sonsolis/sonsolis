...
<head>
    ...
    <title>Computer Vision - Resume</title>
</head>
<body>
    <header>
        <div class = "logo">
...
-->|
    ...
    <div class="page-wrapper">   
		...
		<div class="main-content single">
			<h1 class="post-title">Computer Vision - Portfolio</h1>

			<center><img class="post-img" src="../../images/fields/computervision.jpg" alt=""></center>
		...
		<div class="sidebar single">
			<div class="section popular">
				...
				<div class="post clearfix">
					<img src="../../images/fields/Embedded.jpg" alt="">
					<a href="embedded.html" class="title"><h4>Embedded - Portfolio</h4></a>
				</div>
				<div class="post clearfix">
